...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    neutrons_emitted_check = neutrons_emitted > 500
    metric = temperature * neutrons_emitted
    metric_check = metric < 500_000

    checks = [
        temperature_check,
        neutrons_emitted_check,
        metric_check
        ]
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    metric = temperature * neutrons_produced_per_second
